...
def speechtotext():
    ...
    r.energy_threshold = 275  # minimum audio energy to consider for recording
    r.pause_threshold = 0.35  # seconds of non-speaking audio before a phrase is considered complete
